              ...
              <div className="md:col-span-2 relative w-full p-4">
                <div id="about">
                  ...
                  <span className="text-zinc-400 text-lg">
                    ...
                    while developing a web and mobile application for
                    pre-schools. Little did I know, this would lead me down a
                    path where I&apos;d get to shape and refine my skills in
                    software engineering and web development.
                    <br />
                    <br /> Fast forward to today, and I&apos;ve had the
                    privilege of leading software projects across various
                    sectors—building innovative solutions for an advertising
                    agency, a start-up, a global corporation, and even a digital
                    product studio. Currently, I&apos;m focused on creating
                    accessible and impactful user interfaces at CeX Webuy
                    Entertainment, where I lead a talented team of software
                    engineers. I thrive in the intersection of design and
                    engineering, ensuring that the solutions I build are not
                    only robust under the hood but also deliver a seamless user
                    experience. Outside of work, I&apos;ve contributed to tech
                    by developing a Quality of Service Tool and even ventured
                    into the world of IoT with a Smart Home project. <br />
                    <br />
                    When I&apos;m not coding, you might find me rock climbing,
                    diving into a good book, spending time with my family, or
                    tinkering with new tech ideas. My journey in tech is all
                    about continuous learning and pushing the boundaries of
