...
import MyImage from "./utils/image_square";
import Link from "next/link";
const Home = () => {
  return (
    <div>
      <Head>
        <title>Mohit Singh - Home</title>
        <meta name="description" content="Learn more about Mohit Singh, a lead full stack software engineer." />
      </Head>
            ...
            <div className="webkit-center border-none col-span-7">
              <section className="text-center py-8">
                ...
                <p className="text-xl mb-2 text-gray-400 text-justify px-8">
                  ...
                  , a forward-thinking leader in web development🌐, carving
                  paths through the dynamic world of software engineering.
                  <br />
                  <br />
                  I create dynamic, responsive, and aesthetically pleasing
                  digital solutions that connect with users. With over a decade
                  of experience at the helm of complex projects, I’m driven by a
                  passion for discovering new possibilities and pushing the
                  limits of what technology can achieve.
                  <br />
...
export const metadata:Metadata = {
  ...
  description: "Learn more about Mohit Singh - a full-stack developer"
}
export default Home;
